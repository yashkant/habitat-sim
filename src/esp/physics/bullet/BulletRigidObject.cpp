...
void BulletRigidObject::constructAndAddRigidBody(MotionType mt) {
  ...
  Mn::Debug{} << "BulletRigidObject::constructAndAddRigidBody: " << int(mt);
  ...
  Mn::Debug{} << "sleeping thresholds are: "
              << bObjectRigidBody_->getLinearSleepingThreshold() << ", "
              << bObjectRigidBody_->getAngularSleepingThreshold();
  // bObjectRigidBody_->setSleepingThresholds(0.8, 0.5);
